...
export default function App() {
  const { currentStep, setStep, imageFile } = useEditorStore();
        ...
        {currentStep === 'editor' && imageFile && (
          <div className="w-full max-w-7xl mx-auto px-4 py-6">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4 mb-6">
              <div>
                <h2 className="text-2xl font-extrabold text-white">Crop & Adjust Photo</h2>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 hover:bg-slate-800 text-slate-300 text-xs font-semibold"
                >
                  Change Preset
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs shadow-lg shadow-emerald-500/25"
                >
        ...
        {currentStep === 'compliance' && imageFile && (
          <div className="w-full max-w-4xl mx-auto px-4 py-8 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-extrabold text-white">Passport Compliance Audit</h2>
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-sm shadow-lg shadow-emerald-500/25"
              >
